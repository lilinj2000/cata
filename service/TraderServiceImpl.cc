    ...
    max_order_ref_(-1)
{
  ...
  trader_api_ = CThostFtdcTraderApi::CreateFtdcTraderApi(options_->flow_path.data());
...
void TraderServiceImpl::initSession(CThostFtdcRspUserLoginField* pRspUserLogin)
{
