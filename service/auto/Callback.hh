...
virtual void onRspUserAuthMethod(
	const std::string& theRspUserAuthMethod,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspGenUserCaptcha(
	const std::string& theRspGenUserCaptcha,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspGenUserText(
	const std::string& theRspGenUserText,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspOptionSelfCloseInsert(
	const std::string& theInputOptionSelfClose,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspOptionSelfCloseAction(
	const std::string& theInputOptionSelfCloseAction,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspQrySecAgentTradingAccount(
	const std::string& theTradingAccount,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
...
virtual void onRspQrySecAgentCheckMode(
	const std::string& theSecAgentCheckMode,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspQrySecAgentTradeInfo(
	const std::string& theSecAgentTradeInfo,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspQryOptionSelfClose(
	const std::string& theOptionSelfClose,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
...
virtual void onRspQryInvestUnit(
	const std::string& theInvestUnit,
	const std::string& theRspInfo,
	int nRequestID,
	bool bIsLast) {
	SOIL_FUNC_TRACE;
